...
function ProductInfo() {
  return (
    <div className="productInfo">
      ...
      <div>
        <h1 className="mainTitles">Packaging & Delivery</h1>
        <p>
      ...
      <div>
        <h1 className="mainTitles">Suggested Use</h1>
        <p>Refrigeration not necessary.</p>
        <p>Stir before serving</p>
      </div>

      <div>
        <h1 className="mainTitles">Other Ingredients</h1>
      ...
      <div>
        <h1 className="mainTitles">Warnings</h1>
